      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative glass-strong rounded-3xl p-6 sm:p-10 text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-xs sm:text-base text-gray-400 mb-6 max-w-xl mx-auto">Create a verified creator account, configure your campaign tasks, and share your unlock link.</p>
