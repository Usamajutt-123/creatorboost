  ...
  return <footer className="relative border-t border-white/5 pt-16 sm:pt-20 pb-6 sm:pb-8 bg-gradient-to-b from-[#05030d] to-[#02010a] overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-12 gap-8 mb-12 sm:mb-16">
        ...
        <div className="lg:col-span-2 flex lg:justify-end items-start"><button type="button" onClick={scrollTop} className="glass rounded-xl p-3 hover:bg-white/5 transition group" aria-label="Back to top"><ArrowUp className="w-5 h-5 text-gray-300 group-hover:text-white transition" /><span className="block text-[10px] text-gray-500 mt-1 group-hover:text-gray-300">Top</span></button></div>
      </div>
