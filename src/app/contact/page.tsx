            ...
            <div className="space-y-4">
              <div className="glass-strong rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex justify-between"><span>Live chat</span><span className="text-green-400 flex items-center gap-2"><span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" /> Online</span></li>
              ...
              <div className="glass-strong rounded-2xl p-6">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {['𝕏 Twitter', 'in LinkedIn', '▶ YouTube', '📷 Instagram', '💬 Discord', '📌 GitHub'].map(s => (
                    <a key={s} className="glass rounded-lg p-3 text-center text-xs hover:bg-white/5 transition cursor-pointer">{s}</a>
                  ))}
                </div>
              </div>
              <div className="glass-strong rounded-2xl p-6">
