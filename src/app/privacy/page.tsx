        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-strong rounded-2xl p-6 sm:p-10">
            ...
            <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
              ...
              <section><h2 className="font-display text-xl font-bold text-white mb-3">4. Data Security</h2><p>We use industry-standard encryption (TLS 1.3), Supabase row-level security, and email verification to protect your data. Payment information is never stored on our servers.</p></section>
