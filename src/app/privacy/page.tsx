        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-strong rounded-2xl p-6 sm:p-10">
            ...
            <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
              ...
              <section><h2 className="font-display text-xl font-bold text-white mb-3">4. Data Security</h2><p>We use transport encryption, Supabase row-level security, and email verification to protect account data. Withdrawal account details are stored only to process a requested payout and are restricted to the creator and authorized payout staff. Do not submit unnecessary sensitive information.</p></section>
