        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-strong rounded-2xl p-6 sm:p-10">
            ...
            <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
              ...
              <section><h2 className="font-display text-xl font-bold text-white mb-3">3. Earnings &amp; Payouts</h2><p>Earnings are calculated based on valid views, country CPM rates, and your creator level. CPM rates are subject to change at the admin&apos;s discretion. Minimum withdrawal amount is $10. Payouts are processed within 24-48 hours.</p></section>
