...
/**
 * The user's ticket list is server-rendered (see page.tsx). Everything else —
 * creating tickets, loading conversation messages, replying — keeps its exact
 * previous behavior and server-side authorization.
 */
export default function SupportClient({
  ...
  return (
    <>
      <DashboardTopbar title="Support" userId={userId} unreadCount={unreadCount} />
