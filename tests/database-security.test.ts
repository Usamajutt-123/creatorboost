...
describe('database security invariants', () => {
  it('migrations exist and are ordered', () => {
    ...
    // The additive view traffic-attribution migration is the latest one,
    // following the already-applied 0019 baseline.
    expect(migrations[migrations.length - 1]).toMatch(/^0020_/);
  });
